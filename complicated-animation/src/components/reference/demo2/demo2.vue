...
.highscraper .wall-one div {
  ...
  box-shadow: 0 -8px 0 0 black, 0 10px 0 0 black, 0 20px 0 0 black,
    ...
    0 70px 0 0 black, 0 80px 0 0 black, 0 90px 0 0 black, 0 100px 0 0 black,
    0 110px 0 0 black, 0 120px 0 0 black, 0 130px 0 0 black;
}
...
.highscraper .wall-two div {
  ...
  box-shadow: -8px 0 0 0 black, 10px 0 0 0 black, 20px 0 0 0 black,
    ...
    70px 0 0 0 black, 80px 0 0 0 black, 90px 0 0 0 black, 100px 0 0 0 black,
    110px 0 0 0 black, 120px 0 0 0 black, 130px 0 0 0 black;
}
.highscraper .roof {
  position: absolute;
  display: block;
...
.leaves {
  ...
  box-shadow: -1px 1px 0 0 #3c6a30, -2px 2px 0 0 #3c6a30, -3px 3px 0 0 #3c6a30,
    -4px 4px 0 0 #3c6a30, -5px 5px 0 0 #3c6a30, -6px 6px 0 0 #3c6a30,
    -7px 7px 0 0 #3c6a30, -8px 8px 0 0 #3c6a30, -9px 9px 0 0 #3c6a30,
